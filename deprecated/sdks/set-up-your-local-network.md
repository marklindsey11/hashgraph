...
The list of supported mirror node REST APIs can be found [here](../../docs/mirror-node-api/rest-api.md). You have now set-up your local environment. Check out the following links for more examples.
