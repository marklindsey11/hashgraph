...
For non-fungible tokens, the token ID represents a NFT class. Once the token is created, you will have to mint each NFT using the [token mint](../../../docs/sdks/tokens/mint-a-token.md) operation.
...
| **Fee Schedule Key**   | The key that can change the token's [custom fee](../../../docs/sdks/tokens/custom-token-fees.md) schedule. A custom fee schedule token without a fee schedule key is immutable.                                                                                                                                                                                                                                                                         |
...
| **Custom Fees**        | [Custom fees](../../../docs/sdks/tokens/custom-token-fees.md) to charge during a token transfer transaction that transfers units of this token. Custom fees can either be [fixed](../../../docs/sdks/tokens/custom-token-fees.md#fixed-fee), [fractional](../../../docs/sdks/tokens/custom-token-fees.md#fractional-fee), or [royalty](../../../docs/sdks/tokens/custom-token-fees.md#royalty-fee) fees. You can set up to a maximum of 10 custom fees. |
...
| `setTokenType(<tokenType>)`           | [TokenType](../../../docs/sdks/tokens/token-types.md)                                                                                 | Optional    |
| `setSymbol(<symbol>)`                 | String                                                                                                                                | Required    |
| `setDecimals(<decimal>)`              | int                                                                                                                                   | Optional    |
| `setInitialSupply(<initialSupply>)`   | int                                                                                                                                   | Optional    |
| `setTreasury(<treasury>)`             | [AccountId](../../../docs/sdks/specialized-types.md#accountid)                                                                        | Required    |
| `setAdminKey(<key>)`                  | [PublicKey](../../../docs/sdks/keys/generate-a-new-key-pair.md)                                                                       | Required    |
| `setKycKey(<key>)`                    | [PublicKey](../../../docs/sdks/keys/generate-a-new-key-pair.md)                                                                       | Optional    |
| `setFreezeKey(<key>)`                 | [PublicKey](../../../docs/sdks/keys/generate-a-new-key-pair.md)                                                                       | Optional    |
| `setWipeKey(<key>)`                   | [PublicKey](../../../docs/sdks/keys/generate-a-new-key-pair.md)                                                                       | Optional    |
| `setSupplyKey(<key>)`                 | [PublicKey](../../../docs/sdks/keys/generate-a-new-key-pair.md)                                                                       | Optional    |
...
| `setAutoRenewAccount(<account>)`      | [AccountId](../../../docs/sdks/specialized-types.md#accountid)                                                                        | Optional    |
