...
| **Max Automatic Token Associations** | <p>Accounts can optionally automatically associate tokens to this account if this property is set. You do not need to associate a token prior to transferring it to this account. There is no limit on how many automatic token associations an account can have as of the 0.25 mainnet release. Reference <a href="https://github.com/hashgraph/hedera-improvement-proposal/blob/master/HIP/hip-23.md">HIP-23</a> and <a href="https://hips.hedera.com/hip/hip-367">HIP-367</a>.<br><br>Note: Prior to the 0.25 mainnet release the limit was 1,000.</p> |
