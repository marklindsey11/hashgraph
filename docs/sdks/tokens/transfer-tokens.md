...
| `setTokenTransferApproval(<tokenId>, <accountId>, <isApproved>)` | [TokenId](token-id.md), [AccountId](../specialized-types.md#accountid), boolean                       | The owner account ID and token the spender is authorized to transfer from                                                                                                                                                                               |
| `setNftTransferApproval(<nftId>,<isApproved>)`                   | [NftId](nft-id.md), boolean                                                                           | The NFT ID the  spender is authorized to transfer                                                                                                                                                                                                       |
