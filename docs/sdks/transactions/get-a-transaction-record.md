...
| **Contract Function Result**        | The result returned by a call to a smart contract function. This is part of the response to a ContractCallLocal query, and is in the record for a ContractCall or ContractCreateInstance. The ContractCreateInstance transaction record has the results of the call to the constructor.                               |
...
| **Hbar Allowance Adjustments**      | The current balances of any adjusted hbar allowances as a result of this transaction. This field will only be populated for [`AccountAllowanceAdjustTransaction`](../cryptocurrency/adjust-an-allowance.md).                                                                                                          |
| **Token Allowance Adjustments**     | The current balances of any adjusted token allowances as a result of this transaction. This field will only be populated for [`AccountAllowanceAdjustTransaction`](../cryptocurrency/adjust-an-allowance.md).                                                                                                         |
| **Token Nft Allowance Adjustments** | The current balances of any adjusted NFT allowances as a result of this transaction. This field will only be populated for [`AccountAllowanceAdjustTransaction`](../cryptocurrency/adjust-an-allowance.md).                                                                                                           |
...
| `<TransactionRecord>.hbarAllowanceAdjustments`     |                                             |                 |
| `<TransactionRecord>.tokenAllowanceAdjustments`    |                                             |                 |
| `<TransactionRecord>.tokenNftAllowanceAdjustments` |                                             |                 |
