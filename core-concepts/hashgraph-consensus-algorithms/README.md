...
The [hashrgaph consensus algorithm](https://github.com/hashgraph/hedera-docs/blob/master/core-concepts/hashgraph-consensus-algorithms/\[url]\(https:/github.com/hashgraph/hedera-platform\)/README.md) and platform code is open source under an Apache 2.0 license.
