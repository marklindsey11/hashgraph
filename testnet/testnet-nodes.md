...
Below you will find the testnet account public keys. The public keys stored in the address book are hex encoded keys \(x509\). The testnet address book file ID on is `0.0.102`
